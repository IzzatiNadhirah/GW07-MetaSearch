<?php
// ==========================================================================
// index.php - Group Member Listing with MetaSearch Link
// ==========================================================================
...
<!-- NEW: Button Group with Back and MetaSearch buttons -->
<div class="button-group">
    <a href="../../dashboard.php?group=<?php echo urlencode($group); ?>" class="btn-back">BACK TO DASHBOARD</a>
    <!-- NEW: Go to MetaSearch Button -->
    <a href="https://bitp3353.utem.edu.my/2026/all/GroupMDB/GW07/MetaSearch/" class="btn-metasearch">
        <i style="margin-right: 8px;">🚀</i> Go to MetaSearch
    </a>
</div>
