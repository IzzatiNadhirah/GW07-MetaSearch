...
// --------------------------------------------------------------------------
// 1. Get Group from URL parameter or default
// --------------------------------------------------------------------------
if (!isset($_GET['group'])) {
    $group = 'GS02'; // Default group from mmdb2026.vstu
} else {
...
//    Only runs if remote database is available
// --------------------------------------------------------------------------
$members = [];
$error_message = null;

// ✅ FIXED: Check if remote connection exists before using it
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-2 sidebar p-4">
            ...
            <!-- Group Display -->
            <div class="group-badge text-center mb-4" style="font-size:1rem;padding:6px 15px;">
            ...
            <ul class="nav nav-pills flex-column mt-2">
                ...
                <li class="nav-item">
                    <a href="test.php" class="nav-link">
                        <i class="fa-solid fa-database me-2"></i> Database Viewer
                    </a>
                </li>
            </ul>
        ...
        <div class="col-md-10 p-4 main-content">
            ...
            <div class="card-custom p-4 mb-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5 class="fw-bold text-cyan mb-0">
                        <i class="fa-solid fa-users me-2"></i>Group Members — <?php echo htmlspecialchars($group); ?>
                    </h5>
            ...
            <footer class="mt-4 pt-3 border-top border-secondary text-muted small text-center">
                ...
                MetaSearch — Multimedia Database Project | Group <?php echo htmlspecialchars($group); ?>
            </footer>
        </div>
    </div>
</div>
...
<script>
    ...
    console.log('Group: <?php echo htmlspecialchars($group); ?>');
